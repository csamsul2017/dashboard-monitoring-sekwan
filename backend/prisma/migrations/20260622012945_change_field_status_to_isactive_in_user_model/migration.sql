...
INSERT INTO "new_User" ("created_at", "dept_id", "email", "id", "last_login", "name", "nip", "password", "role_id", "updated_at") SELECT "created_at", "dept_id", "email", "id", "last_login", "name", "nip", "password", "role_id", "updated_at" FROM "User";
DROP TABLE "User";
